          ...
          <div class="col-sm-12 print-div" id="printarea">
                ...
                <div class="print-quot22">
                  <div class="row">
                    <div class="col-sm-3 logo-div">
                      <img src="loginpage.png" class="img-responsive" style={{ width: '100%' }} />
                    </div>
                    ...
                    <div class="col-sm-5">
                      <div class="print-quot33">
                        <div class="row">
                          ...
                          <div class="col-sm-12 pt-right" style={{ marginLeft: '165px', marginTop: '-22px' }}>
                          {quotDate}                             </div>
                        </div>
            ...
            <div class="row print-detail">
              <div class="col-sm-6 left1">
                <div class="print-detail11">
                  ...
                  <p class="m-0">Al-Jubail St P.O. Box 2816, Jubail 31951, Saudi Arabia<br />
                  ...
                  <div class="row pd3-det">
                    <div class="col-sm-12">
                      <div class="row">
                        ...
                        <div class="col-sm-7 pri-field-data">
                        {wosdate}                        </div>
                      </div>
                      ...
                      <div class="row">
                        <div class="col-sm-5 pri-field-head">User Mobile No.:</div>
                        <div class="col-sm-7 pri-field-data">
                        {entMobile}                          </div>
                      </div>
            ...
            <div className="row">
              <div className="col-sm-12 mt-3">
                <div className="">
                  <table className="table table-bordered" style={{ width: '121%' }}>
                    <thead>
                      <tr>
                        <th>Serial No.</th>
                        <th>Description</th>
...
<h5>
FOR ENTEMA AL SHAMAL GEN. CONT. EST
</h5>
