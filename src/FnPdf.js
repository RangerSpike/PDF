                ...
                <div className="row">
                                ...
                                <div class="print-quot">
                                    <div class="row ">
                                        <div class="col-sm-3 logo-div">
                                            <img src="loginpage.png" className="img-responsive" style={{ width: '100%' }} />
                                        </div>
                                        ...
                                        <div class="print-quot3">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-7 col-xs-8 pt-right">
                                                {podocno}                              </div>
                                            </div>
                                ...
                                <div class="row pd3-det">
                                    <div class="col-sm-5 left1">
                                        <div class="row">
                                            ...
                                            <div class="col-sm-5 pri-field-data pon">
                                            ponumber   </div>
                                        </div>

                                        <div class="row">
                                            <div class="col-sm-7 pri-field-head">Project:</div>
                                            <div class="col-sm-5 pri-field-data">
                                            {poproject}                         </div>
                                        </div>
                                    ...
                                    <div class="col-sm-12">
                                        <div class="row">
                                            <div class="col-sm-6 pri-field-head">Mode / Terms Payment :</div>
                                    ...
                                    <div class="col-sm-7 ">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-8 pri-field-data" style={{ marginLeft: "149px", marginTop: "-21px" }}>
                                            {poquotationref}                          </div>
                                        </div>
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="dash-pr">
                                <div class="row">
                                    <div class="col-sm-2 pri-field-head">Description of Work:</div>
                                    <div class="col-sm-10 pri-field-data">
                                    {podesc}            </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-6">
                            <div class="print-total row mr-0">
                                ...
                                <div class="col-6 col-xs-6 tot-left">s.tAX/vat/rgst {pogst} </div>
                                <div class="col-6 col-xs-6 tot-right">
                                {pogst}              </div>
                                <div class="col-sm-6 col-xs-6 tot-left tl2">gRAND tOTAL (sAR)</div>
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="print-total1">
                                <h4><span>TOTAL (IN WORDS ):<span id="total_word" style={{ display: 'inline' }}>{toWords(pograndtotal)}</span> SAR <span id="total_decimal" style={{ display: 'inline' }}></span>Only</span>
                                </h4>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-12">
                            <div class="dash-terms mt-0 pt-0">
                                ...
                                {" "}
                                <p>1. Lubricants, top-up oil, repairs, daily maintenance, Service. and Consumables of the Equipments shall be provide by Vender.<br />
                                    2. In case of breakDown or Maintenance, Vwndor/Supplier shall provide a replacement of equipment immediatly at no extra cost.</p>
                                    {" "}       </div>
                        </div>
                        ...
                        <div class="col-sm-12">
                            <div class="dash-terms mt-0 pt-0">
                                ...
                                <p>
                                {" "}1. Above rate is applicable for 10 hours per day, 6 days a week, 260 hours per Month.<br />
                                    2. Working Duration: 2 Month Extandable.<br />
                                    3. Supply Food, accommodation &amp; Transportation scope Entema al-shamal.<br />
                                    ...
                                    <div class="bot-cl2">
                                        ...
                                        <div className="row">
                                            <div className="col-md-5 col-xs-6 bot-left">
                                                Signature
                                            </div>
